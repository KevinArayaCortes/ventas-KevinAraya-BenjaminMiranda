    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(help_text=" (ej.'912345678').", max_length=9, validators=[django.core.validators.RegexValidator(message='El teléfono debe contener 9 dígitos.', regex='^\\d{9}$')])),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('En proceso', 'En proceso'), ('Enviado', 'Enviado'), ('Completado', 'Completado')], default='En proceso', max_length=20, validators=[django.core.validators.MinLengthValidator(3)])),
